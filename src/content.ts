...
const banners = {
	submissionAccepted: "banners/mission_passed.png",
	submissionRejected: "banners/mission_failed.png",
} as const;

export type Actions = keyof typeof banners;

const sounds = {
	newItem: "sounds/mission_passed.mp3",
	enemyFailed: "sounds/mission_failed.mp3",
} as const;
...
console.log(
	"LeetCode Banner Extension - Content script loaded on:",
...
function show(
	...
	banner.onerror = () => {
		...
		fallbackBanner.textContent = action
			.replace(/([A-Z])/g, " $1")
